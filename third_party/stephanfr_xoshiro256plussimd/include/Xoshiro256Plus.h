...
namespace SEFUtility::RNG
{
    ...
    class Xoshiro256Plus
    {
       ...
       private:
        ...
        {
            const __m256i sum = _mm256_add_epi64(state[0], state[3]);
            FourIntegerValues result(_mm256_add_epi64(rotl<23>(sum), state[0]));
        ...
        template <int k>
        static inline __m256i rotl(const __m256i x)
        {
#ifdef __AVX512VL__
